...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('newpledgeid')); ?>:</b>
	<?php echo CHtml::encode($data->newpledgeid); ?>
	<br />
	...
	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('tarehe')); ?>:</b>
	<?php echo CHtml::encode($data->tarehe); ?>
	<br />
