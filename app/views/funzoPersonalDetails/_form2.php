...
<table>
	...
	<tr>
		...
		<td>
			<?php echo $form->dropDownList($funzoUniversitydetails,'UNIVERSITY_CODE',TblFunzoInstitutions::showinstitutions(),array('size'=>1,'maxlength'=>50)); ?>
	...
	<tr>
		...
		<?php echo $form->labelEx($tblPastapplicants,'AMOUNT'); ?>		
		</td>
		<td>
	...
	<tr>
		...
		<?php echo $form->textField($tblPastapplicants,'AMOUNT',array('size'=>20,'maxlength'=>50)); ?>
		<?php echo $form->error($tblPastapplicants,'AMOUNT'); ?>
		</td>
		<td>
	...
	<div class="" id="SaveStud_div">
		 ...
		 <?php
			...
			echo CHtml::ajaxSubmitButton('Save Record',array('tblPastapplicants/SaveStud?idno='.$idno),
					array (
						'update'=>'#SearchStud_update',
						'type'=>'submit',
						'beforeSend'=>'function(){
						  $(\'body\').undelegate(\'#SaveStud\', \'click\');
						  $("#SaveStud_div").hide();
