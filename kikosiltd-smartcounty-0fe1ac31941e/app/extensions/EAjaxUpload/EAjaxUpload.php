...
class EAjaxUpload extends CWidget {
        ...
        public function run()
        {
                ...
                Yii::app()->clientScript->registerScriptFile($baseUrl . '/fineuploader-3.7.0.min.js', CClientScript::POS_END);

                $this->css = (!empty($this->css)) ? $this->css : $baseUrl . '/fineuploader-3.7.0.min.css';
