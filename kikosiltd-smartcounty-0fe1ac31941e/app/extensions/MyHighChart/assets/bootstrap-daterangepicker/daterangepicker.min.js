!function(b) {
        var a = function(k, s, i) {
                ...
                this.parentEl = (q && s.parentEl && b(s.parentEl)) || b(this.parentEl);
                this.container = b(d).appendTo(this.parentEl);
                if (q) {
        ...
        a.prototype = {constructor: a, mousedown: function(c) {
                        ...
                        var c = {top: this.parentEl.offset().top - (this.parentEl.is("body") ? 0 : this.parentEl.scrollTop()), left: this.parentEl.offset().left - (this.parentEl.is("body") ? 0 : this.parentEl.scrollLeft())};
                        if (this.opens == "left") {
                                this.container.css({top: this.element.offset().top + this.element.outerHeight() - c.top, right: b(window).width() - this.element.offset().left - this.element.outerWidth() - c.left, left: "auto"});
                                if (this.container.offset().left < 0) {
                                        this.container.css({right: "auto", left: 9})
                                }
                        } else {
                                this.container.css({top: this.element.offset().top + this.element.outerHeight() - c.top, left: this.element.offset().left - c.left, right: "auto"});
                        ...
                        var d = parseInt(f.find(".monthselect").val(), 10);
                        ...
                        var f = moment([l, m, n, 12, g]);
                        for (var j = 0, d = 0, s = 0; j < 42; j++, d++, f = moment(f).add("hour", 24)) {
                                if (j > 0 && d % 7 == 0) {
                                        d = 0;
                                        s++
                                }
                                k[s][d] = f.clone().hour(h);
                                f.hour(12)
                        }
                        return k
