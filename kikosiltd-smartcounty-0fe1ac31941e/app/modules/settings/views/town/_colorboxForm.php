...
<div class="my-colobox">
        ...
        <div class="form-group">
                <?php echo $form->labelEx($model, 'country_id', array('class' => 'col-lg-3 control-label')); ?>
                <div class="col-lg-9">
                        <?php echo $form->dropDownList($model, 'country_id', SettingsCountry::model()->getListData('id', 'name'), array('class' => 'form-control')); ?>
                </div>
        </div>
