...
$this->widget('application.components.widgets.GridView', array(
    ...
    'columns' => array(
        ...
        array(
            'name' => 'name',
            'type' => 'raw',
            'value' => 'CHtml::link(CHtml::encode($data->name),Yii::app()->controller->createUrl("update",array("id"=>$data->id)))'
        ),
        array(
            'class' => 'ButtonColumn',
            ...
            'buttons' => array(
                'update' => array(
                    ...
                    'visible' => '$this->grid->owner->showLink("' . UserResources::RES_SETTINGS_PAGE . '","' . Acl::ACTION_UPDATE . '")?true:false',
                    'options' => array(
                        'class' => 'green',
                        'title' => 'Edit',
                    ),
                ...
                'delete' => array(
                    ...
                    'visible' => '$this->grid->owner->showLink("' . UserResources::RES_SETTINGS_PAGE . '", "' . Acl::ACTION_DELETE . '")?true:false',
                    'options' => array(
                        'class' => 'delete red',
                        'title' => 'Delete',
                    ),
