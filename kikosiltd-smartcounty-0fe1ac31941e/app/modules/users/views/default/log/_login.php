<div class="my-colobox" style="min-width: 500px">
        ...
        <div class="row grid-view-header">
                <div class="col-lg-6">
                        <div class="btn-group">
                                <?php if ($can_delete): ?><button class="btn btn-sm grid_delete_multiple" type="button" data-ajax-url="<?php echo $this->createUrl('deleteLog', array('t' => $this::LOG_LOGIN)) ?>" data-grid_id="<?php echo $grid_id; ?>"><i class="icon-trash"></i>&nbsp;<?php echo Lang::t('Delete selected') ?></button><?php endif ?>
                        </div>
                </div>
                <div class="col-lg-6">
