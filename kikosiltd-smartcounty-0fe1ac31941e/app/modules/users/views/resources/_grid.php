        ...
        array(
            ...
            'buttons' => array(
                'update' => array(
                    ...
                    'visible' => '$this->grid->owner->showLink("' . UserResources::RES_USER_RESOURCES . '","' . Acl::ACTION_UPDATE . '")?true:false',
                    'options' => array(
                        'class' => 'green',
                        'title' => 'Edit',
                    ),
                ...
                'delete' => array(
                    ...
                    'visible' => '$this->grid->owner->showLink("' . UserResources::RES_USER_RESOURCES . '", "' . Acl::ACTION_DELETE . '")?true:false',
                    'options' => array(
                        'class' => 'delete red',
                        'title' => 'Delete',
                    ),
